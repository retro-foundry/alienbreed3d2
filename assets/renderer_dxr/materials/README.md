...
`Draw_Wall` U/V window; a floor or ceiling uses its complete 256-by-256
replacement for the selected 64-by-64 `Draw_Flats` source tile. Both generate
mip pyramids:
...
use those isolated pyramids without changing water or non-world
