...
int level_runtime_get_zone_edge_index(const LevelRuntime *runtime, uint16_t zone_index,
                                      ...
                                      char *error, size_t error_size);
/*
 * objectmove.s:checkotherwalls restarts at the list beginning for a non-zero
 * Obj_ExtLen_w, processes all non-negative entries across separators, and
 * stops at -2. Player movement uses this second pass with extension length 40.
 */
